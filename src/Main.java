...
public class Main {
    ...
    private static void turn(Scanner in, String player)
    {
        ...
        do
        {
            ...
            tempCol = SafeInput.getRangedInt(in, "Enter the column you want to place your pawn: ", 1, 3) - 1;
            tempRow = SafeInput.getRangedInt(in, "Enter the row you want to place your pawn: ", 1, 3) - 1;
